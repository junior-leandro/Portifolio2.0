    ...
    return (
        <section className="w-full h-full flex flex-col items-center bg-primary-blue" id="projetos">
            ...
            <div className="w-full h-full text-center">
                <div className="shadow-xl w-1/2 min-w-max max-w-[1800px] mx-auto my-10 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer">
                <a href="https://github.com/junior-leandro/" target="_blank" className="text-white text-xs lg:text-lg p-2 border-2 rounded-xl">Clique aqui para ver mais projetos meus no GitHub</a>
                </div>
            </div>
